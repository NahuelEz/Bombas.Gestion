...
{
    public partial class PV_ContactManager_Contact : Form
    {
        private ProviderContact CurrentContact = null;

        public PV_ContactManager_Contact(ProviderContact Contact = null)
        {
            this.CurrentContact = Contact;
            InitializeComponent();
        }

        private void PV_ContactManager_Contact_Load(object sender, EventArgs e)
        {
        ...
        private void btnAccept_Click(object sender, EventArgs e)
        {
            ...
            if (CurrentContact == null)
            {
                ((PV_ContactManager)(this.Owner)).Contacts.Add(new ProviderContact()
                {
