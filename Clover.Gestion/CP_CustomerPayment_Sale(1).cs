...
{
    public partial class CP_CustomerPayment_Sale : Form
    {
        ...
        public CP_CustomerPayment_Sale(int CustomerID, IList<Sale> CurrentSales)
        {
        ...
        private async void CP_CustomerPayment_Sale_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception dbException)
            {
                ...
                Logger.AppendLog("Exception at Waypoint CP501 (Flag: MySQL). Message: " + dbException.Message);
                this.Close();
                return;
            }
